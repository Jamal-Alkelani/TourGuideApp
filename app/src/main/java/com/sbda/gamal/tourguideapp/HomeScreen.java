...
public class HomeScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Place place=new Place("Italy",R.drawable.italy,"The best place to spend holides and relax");
        place.setToursInfo(new ToursInfo("Naples",R.drawable.naples,"6.0 Km, 2 hours",new Location("italy","23-XYZStreet")));
        place.setToursInfo(new ToursInfo("Cinque Terre",R.drawable.cinque_terre,"6.0 Km, 2 hours",new Location("italy","23-XYZStreet")));
        place.setToursInfo(new ToursInfo("Milan ",R.drawable.cinque_terre,"6.0 Km, 2 hours",new Location("italy","23-XYZStreet")));
        place.setToursInfo(new ToursInfo("Naples",R.drawable.naples,"6.0 Km, 2 hours",new Location("italy","23-XYZStreet")));
        place.setToursInfo(new ToursInfo("Cinque Terre",R.drawable.cinque_terre,"6.0 Km, 2 hours",new Location("italy","23-XYZStreet")));
        place.setToursInfo(new ToursInfo("Milan ",R.drawable.cinque_terre,"6.0 Km, 2 hours",new Location("italy","23-XYZStreet")));
        place.setToursInfo(new ToursInfo("Naples",R.drawable.naples,"6.0 Km, 2 hours",new Location("italy","23-XYZStreet")));
        ...
        hotelsInfo.add(new HotelsInfo("ram ",R.drawable.ram,"100$ per day",new Location("italy","23-XYZStreet")));
        hotelsInfo.add(new HotelsInfo("amba ",R.drawable.amba,"150$ per day",new Location("italy","23-XYZStreet")));
        hotelsInfo.add(new HotelsInfo("rolies ",R.drawable.ram,"10$ per day",new Location("italy","23-XYZStreet")));
        hotelsInfo.add(new HotelsInfo("KSA ",R.drawable.ram,"80$ per day",new Location("italy","23-XYZStreet")));
        hotelsInfo.add(new HotelsInfo("brandHotels",R.drawable.ram,"950$ per day",new Location("italy","23-XYZStreet")));
